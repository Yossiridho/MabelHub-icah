...
function CategoryCard({
  ...
  return (
    ...
    >
      {/* Delete X button - top right corner, SUPERADMIN only */}
      {isSuperAdmin && onDelete && (
        <button
          ...
          className="absolute top-3 right-3 z-10 w-7 h-7 flex items-center justify-center rounded-full bg-gray-100 text-gray-400 ring-1 ring-gray-200 opacity-0 group-hover:opacity-100 hover:bg-red-50 hover:text-red-500 hover:ring-red-300 transition-all duration-200 active:scale-90"
...
export default function ProdukPage() {
  ...
  const handleDeleteCategory = async () => {
    ...
    try {
      const res = await fetch(`/api/produk/categories/${deletingCatId}`, {
        method: "DELETE",
      });
                ...
                <div className="p-5">
                  ...
                  <div className="mt-3 p-3 bg-red-50 rounded-xl border border-red-100">
                    <p className="text-xs text-red-600 font-semibold flex items-center gap-1.5">
                      ...
                      Semua dokumen dalam kategori ini juga akan dihapus secara permanen.
                    </p>
                  </div>
                </div>
                <div className="p-5 border-t border-gray-100 flex gap-3">
                  ...
                  <button
                    ...
                    disabled={isDeleting}
                    className="flex-1 py-2.5 rounded-xl bg-red-600 text-white text-sm font-bold shadow-sm hover:bg-red-700 disabled:opacity-50 transition flex items-center justify-center gap-2"
                  >
                    {isDeleting ? (
                      <>
